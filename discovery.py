...
# Канальные паки — каналы где сидит САМА ЦА и читает контент про свою профессию.
# НЕ маркетинговые каналы (там не наша аудитория).
CHANNEL_PACKS: dict[str, list[str]] = {
    "beauty": [
        # каналы для мастеров и про индустрию
        "нейл арт",
        "ногтевой сервис",
        "брови ресницы",
        "ламинирование",
        ...
        "парикмахер блог",
        "барбер блог",
        # каналы для владельцев салонов (не маркетологи)
        "салон красоты",
        "владелец салона",
    ],
    "selfworkers": [
    ...
    "automation": [
        # инструменты, новости индустрии — где сидят те кто пользуется
        "yclients",
        "altegio",
        "автоматизация записи",
        "онлайн запись",
